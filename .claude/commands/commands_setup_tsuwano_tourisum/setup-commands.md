...
description: >
  ...
  各コマンドは Phase 4 (Skill) と Phase 5 (Agent) で作成されたものを組み合わせて呼び出す。
...
> Phase 6 of 8. Let's think step by step.
...
基本 Skill / Agent が存在することを確認。Commands はこれらを呼び出す。
...
`.steering/_setup-progress.md` の Phase 6 を完了マーク + 相互参照マップ更新:

```markdown
- [x] **Phase 6: /setup-commands** — ワークフローコマンド群
