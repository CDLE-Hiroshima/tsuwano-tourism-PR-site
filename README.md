...
MVP のあとは、Claude Code に **直接お願い**して 1 手ずつ育てます。おすすめは
...
また、上記に関してのissueらなどを挙げることも重要ですが、それらに合わせた上でのWeb上でのリサーチなどもエージェントは行なってくれるため、具体的な情報などを収集しながら先人らの技術や知見を参考にさせた上で、自分自身で作成するサイトをレベルアップさせるのも一つの手です。また、issue + 先人らの知見や技術などを組み合わせた上での具体的なプロンプトなどをsteeringで作成させてから、新しいセッションなどで具体的な改善を実施するのがオススメです(コンテキストの都合上)
